...
Amber LF is a basic local firewall implementation via iptables to try to protect the host machine by only allowing the specific bidirectional traffic configured by the user.
